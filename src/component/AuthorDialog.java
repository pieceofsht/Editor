...
public class AuthorDialog extends JDialog {
	...
	public AuthorDialog(Frame owner, String title) {
		...
		JLabel ins=new JLabel("author:—ÓÃÏ∫º");
		ins.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 19));
		ins.setBounds(10,20,150,30);
		p.add(ins);

		JLabel ins1=new JLabel("   ’‘”Ó∫Ω");
		ins1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 19));
		ins1.setBounds(10,50,150,30);
		p.add(ins1);
		
		JLabel ins2=new JLabel("date:11-10");
		ins2.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 19));
		ins2.setBounds(10,80,150,60);
		p.add(ins2);
		
		final JLabel ins3=new JLabel("Ω¯»ÎToiletEditorπŸ∑ΩÕ¯’æ");
		ins3.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 10));
